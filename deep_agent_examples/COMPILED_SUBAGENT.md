...
- 真实模型与 LangSmith：[examples/compiled_subagent.py](examples/compiled_subagent.py)
- 确定性测试：[examples/test_compiled_subagent.py](examples/test_compiled_subagent.py)
