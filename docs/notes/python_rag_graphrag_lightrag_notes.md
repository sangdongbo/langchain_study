...
![普通混合 RAG、Microsoft GraphRAG 与 LightRAG 对比](../assets/rag-approach-comparison.png)
...
- 基础 RAG 笔记：`docs/notes/python_rag_notes.md`
- Milvus 笔记：`docs/notes/python_milvus_notes.md`
- 配套 Notebook：`docs/notes/python_rag_graphrag_lightrag_notes.ipynb`
